...
func NewGoogleAuthUseCase(UserRepository domain_repositories.UserRepository, jwtProvider providers.JwtProvider) *GoogleAuthUseCase {
	return &GoogleAuthUseCase{UserRepository: UserRepository, jwtProvider: jwtProvider}
}
